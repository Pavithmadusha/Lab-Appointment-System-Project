...
<head>
    ...
    <style>
        body {
    background-image: url('img/z1.jpg'); /* Replace 'path/to/your/image.jpg' with the actual path to your background image */
        ...
        <table border="0">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <a href="login.php" class="hover-link1 style-link">Login</a>
                    <br><br><br>
                </td>
            </tr>
